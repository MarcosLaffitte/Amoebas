...
def dibujarGraficas(listaDeGraficas, nombreDeArchivo):
    ...
    estSG = ""             # estructura de SG e.g. S_n, C_n, A_n, ...
    estSGuK1 = ""          # estructura de SGuK1 e.g. S_n+1, C_n+1, A_n+1, ...    
    ...
    while(actual < len(listaDeGraficas)):
        ...
        for sub in range(1, graficasPorHoja + 1):
            ...
            (nombreG6, orden, tamano, familia, estSG, estSGuK1) = listaDeGraficas[actual]
            # hacer subplot
